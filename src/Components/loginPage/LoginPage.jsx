...
function LoginPage() {
    ...
    // Define the guestLoginHandler to dispatch the action when clicking the Guest User button
    const guestLoginHandler = () => {
        dispatch(uiAction.authenticateAsGuest(true));
    }
    ...
    return (
        <section className="mx-auto w-[24rem] h-[30rem] rounded-lg mt-24 shadow-[0_1px_2px_0_rgba(60,64,67,0.3),0_2px_6px_2px_rgba(60,64,67,0.15)] md:w-[19rem]">
            <div className="flex flex-col p-4 w-4/5 mx-auto">
                <div className="text-3xl text-customNavy font-bold h-16 mt-4 mx-auto">Login</div>
                <div className="mb-4">
                ...
                <button className="bg-[#0069e0] disabled:bg-[#0069e0] rounded-lg p-4 text-customBluefont mb-4 disabled flex justify-around relative group">
                    ...
                    <div className="inline mr-24 ml-auto md:mr-[5rem]">Login</div>
                    <svg className="hidden group-hover:inline absolute inset-[-10rem] left-8 md:left-[2rem]" xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 24 24" fill="#FFFFFF" stroke="#000000" strokeWidth="0.2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <Link to={'/'} className="bg-[#463aa1] hover:bg-[#3b3187] rounded-lg p-4 text-customBluefont mb-4 text-center" onClick={guestLoginHandler}>
                    Guest User
                </Link>
                <div className=" text-center">Not a member yet? 
                    <Link to={'/register'}>
                        <div className="inline text-[#0069e0] hover:text-blue-800 hover:solid hover:border-blue-800 hover:border-b-2 ">
                            Register
                        </div>
                    </Link>
                </div>
